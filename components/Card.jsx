    ...
    <>
      {
        ...
        movies?.map((movie) => {
         const {id,title,image,director,genre,release_year,abstract}=movie
          return (
            <div key={id} className="block rounded-xl bg-white shadow-xl dark:bg-neutral-700 text-center basis-1/4">
              {
