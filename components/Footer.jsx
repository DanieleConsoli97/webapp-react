const Footer = () => {
    return (
        <>
            <div className="flex flex-col w-full h-fit bg-[#374151] text-[#e5e7eb] px-48 py-6">
                <div className="flex flex-row">
                    <div className="flex flex-col gap-2 justify-center w-[35%] w-[35%]">
                        <div className="flex items-center w-full gap-4">
                            ...
                            <div className="text-5xl font-bold ">Your Company</div>
                    ...
                    <div className="flex flex-row w-[65%] justify-end gap-16 text-nowrap">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <form className="flex items-center">
                                <input type="email" name="email" placeholder="Enter your email" className="w-full bg-gray-100 text-gray-700 rounded-l-lg py-3 px-4 focus:outline-hidden focus:ring-purple-600 focus:border-transparent"  required="" />
