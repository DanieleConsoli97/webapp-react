const Footer = () => {
    return (
        <>
            <div class="flex flex-col w-full h-fit bg-[#374151] text-[#e5e7eb] px-48 py-6">
                <div class="flex flex-row">
                    <div class="flex flex-col gap-2 justify-center w-[35%] w-[35%]">
                        <div class="flex items-center w-full gap-4">
                            ...
                            <div class="text-5xl font-bold ">Your Company</div>
                    ...
                    <div class="flex flex-row w-[65%] justify-end gap-16 text-nowrap">
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <form class="flex items-center">
                                <input type="email" name="email" placeholder="Enter your email" class="w-full bg-gray-100 text-gray-700 rounded-l-lg py-3 px-4 focus:outline-hidden focus:ring-purple-600 focus:border-transparent" autocomplete="off" required="" />
                ...
                <div class="text-center">© 2025 Your Companys - All rights reserved.</div>
            </div>
        </>
    )
}
