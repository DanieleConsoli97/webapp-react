                ...
                <div className="relative rounded-2xl bg-white p-4 shadow">
                    <div className="mb-4 flex items-center justify-between">
                        <form onSubmit={HandleSubmit} className="form flex flex-col gap-2 m-auto items-center mt-3 text-center basis-1/3" >
                            ...
                            <input className="mb-3 w-full rounded-lg border border-gray-200  text-xl focus:outline-none focus:ring-2 focus:ring-blue-500" name="name" type="text" value={review.name} onChange={addDataForm} />
                            <label className="text-xl font-semibold text-gray-900" htmlFor="">Text</label>
                            <input className="mb-3 w-full rounded-lg border border-gray-200 text-xl focus:outline-none focus:ring-2 focus:ring-blue-500" name="text" type="text" value={review.text} onChange={addDataForm} />
                            <label className="text-xl font-semibold text-gray-900" htmlFor="">Vote</label>
                            <input className="mb-3 w-full rounded-lg border border-gray-200  text-xl focus:outline-none focus:ring-2 focus:ring-blue-500" name="vote" type="text" value={review.vote} onChange={addDataForm} />
